...
namespace WIPR_FinalTermProject.Forms_layer
{
    ...
    {
        private FavoritePlaylistBLL favoritePlaylistBLL = new FavoritePlaylistBLL();
        ...
        private void LoadFavoritePlaylists()
        {
            ...
            dgvFavorites.DataSource = favoritePlaylistBLL.GetByUserId(UserBLL.CurrentUser.UserID ?? 0);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (favoritePlaylistBLL.Add(UserBLL.CurrentUser.UserID ?? 0, playlistId))
            {
                LoadFavoritePlaylists();
